...
filters = ['exch_nasd','sh_relvol_o2.5']  # Shows companies in NASDAQ which are in the S&P500
signal = 'ta_mostactive'
stock_list = Screener(filters=filters, table='Performance', signal=signal)  # Get the performance table and sort it by price ascending
print(stock_list)
# Export the screener results to .csv
...
filters = ['exch_nyse','sh_relvol_o1']  # Shows companies in NASDAQ which are in the S&P500
signal = 'ta_mostactive'
stock_list = Screener(filters=filters, table='Performance', signal=signal)  # Get the performance table and sort it by price ascending
print(stock_list)
# Export the screener results to .csv
